    ...
    <div className='footer-body'>
      <footer>
        <ul className='social_icon'>
          ...
          <li><a href="https://twitter.com/Souurrav" rel="noreferrer" target='_blank'><FaTwitter /></a></li>
          <li><a href="https://www.linkedin.com/in/souravmahapatra1998/" rel="noreferrer" target='_blank'><FaLinkedin /></a></li>
          <li><a href="https://github.com/1Sourav1" rel="noreferrer" target='_blank'><FaGithub /></a></li>
        </ul>
        <ul className='menu'>
