    ...
    <div name="About" className='h-screen overflow-x-hidden bg-gradient-to-b from-gray-800 to-black text-white'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
        ...
        <p className='text-xl mt-20'>
          Hi Everyone, I am Sourav Mahapatra from Bhubaneswar,India.
        ...
        <div className='text-xl mt-5'>
          <h3 className="details"><BsFillPersonFill /> <span>Sourav Mahapatra</span></h3>
          <h3 className="details"><AiFillPhone />+91-9668785793</h3>
          <h3 className="details"><AiOutlineMail />souravmohapatra1920@gmail.com</h3>
